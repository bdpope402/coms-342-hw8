...
public class Reader {
	...
	protected String getProgramDirectory() {
		String buildDir = "typelang" + java.io.File.separatorChar + "src" + java.io.File.separatorChar + "main" + java.io.File.separatorChar  + "java" + java.io.File.separatorChar + "Example" + java.io.File.separatorChar;
		return buildDir; 
	}
